# Operation Manifest and Receipt

Before the first mutation record the fixed sandbox, objective, approved facts, audience context, proposed resources, deterministic names, normalized content/configuration, dependencies, reuse decisions, lifecycle targets, policy inputs, unresolved facts, external AJO steps, and required approvals.
